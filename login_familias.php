...
if (isset($_POST['email_p'])) { //SE DECLARAN VARIABLES QUE TENDRAN EL VALOR DE LOS CAMPOS DEL FORMULARIO
  ...
  $LoginRS__query=sprintf("SELECT id_nump, email_p, password_p, type_p FROM us_padres WHERE email_p=%s AND password_p=%s AND status_p=1",
  ...
  $_SESSION['MM_id_nump'] = $row_LoginRS["id_nump"]; 
...
<!-- Formulario -->
                ...
                <form  id="form1" name="form1" method="POST" action="<?php echo $loginFormAction; ?>">
                  <table align="center">
                    ...
                    <tr valign="baseline">
                   <td>Email:</td>
                   <td><input type="email" name="email_p" placeholder="ejemplo@correo.com" style="width:240px;height:px" required /></td>
                    </tr>

                    <tr valign="baseline">
                   <td>Password:</td>
                   <td><input type="password" name="password_p" placeholder="password" style="width:240px;height:40px" required/></td>
                    </tr>
